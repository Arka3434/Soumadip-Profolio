...
export const About: React.FC<AboutProps> = ({ data, onOpenResume }) => {
  ...
  return (
    <section id="about" className="py-20 px-4 sm:px-6 border-t border-gray-200 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          {/* Main Bio Text */}
          <div className="lg:col-span-7 space-y-4 text-gray-600 text-base leading-relaxed">
            <p>
            ...
            <div className="p-4 rounded-2xl bg-emerald-50/80 border border-emerald-200/90 text-sm text-gray-800 font-medium">
            ...
            <div className="pt-2 flex flex-wrap gap-2.5">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gray-100 border border-gray-200 text-xs font-medium text-gray-700">
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-3.5">
            {highlights.map((item, index) => (
              <motion.div
                ...
                className="p-4 rounded-2xl bg-gray-50 border border-gray-200 shadow-xs flex flex-col justify-between"
              >
            ...
            <div className="col-span-2 p-4 rounded-2xl bg-gray-50 border border-gray-200 text-xs text-gray-600 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-gray-400 font-mono">Location</span>
                <span className="text-gray-800 font-medium">{data.location || 'Haldia, West Bengal, India'}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-400 font-mono">Direct Phone</span>
                <a href={`tel:${data.phone.replace(/[^+\d]/g, '')}`} className="text-emerald-700 font-semibold hover:underline">
                  {data.phone}
                </a>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-400 font-mono">Direct Email</span>
